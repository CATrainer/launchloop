...
<body>
    ...
    <p>This is a sample landing page created by the seed script.</p>
    <p><strong>Note:</strong> This is placeholder content. Real pages are generated by the system.</p>
    <a href="#signup" class="cta">Get Early Access</a>
</body>
</html>
        """
        ...
        for i in range(3):
            project = Project(
                ...
                template_id="problem-first",
                html_content=sample_html if i > 0 else None,  # Add HTML for published projects
                signups_count=i * 2,
                published_at=datetime.utcnow() if i > 0 else None
            )
            db.add(project)
